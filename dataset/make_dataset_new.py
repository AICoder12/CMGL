...
if __name__ == "__main__":
    ...
    Visa_Dataset = Visa_dataset("/home/user/Fourth/ZAS/Dataset/VisA")   # original dataset path
    ...
    Mvtec_Dataset = Mvtec_dataset("/home/user/Fourth/ZAS/Dataset/MVTec")  #original dataset path
